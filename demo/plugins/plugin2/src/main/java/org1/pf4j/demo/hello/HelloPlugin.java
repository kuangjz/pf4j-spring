...
public class HelloPlugin extends SpringPlugin {
    ...
    @Override
    public void start() {
        System.out.println(String.format("{%s}\tHelloPlugin.start()...." + this.wrapper.getPluginPath(),getClass().getName()));
    }

    @Override
    public void stop() {
        System.out.println(String.format("{%s}\tHelloPlugin.stop()",getClass().getName()));
...
//        System.out.println(String.format("{%s}'createApplicationContext\t>>>>>>helloplugin's parent {%s}>>>>>>>>>",getClass().getName(),applicationContext.getParent()));
